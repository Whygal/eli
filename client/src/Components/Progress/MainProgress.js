        ...
        <div className=''>
            ...
            <div>
                <svg
                    ...
                    width="280" zoomAndPan="magnify" viewBox="0 0 210 89.999999" height="120" preserveAspectRatio="xMidYMid meet" version="1.0">
                    <path stroke-linecap="butt" transform="matrix(0.613411, 0.437224, -0.435317, 0.610736, 28.138421, 3.587267)" fill="none" stroke-linejoin="miter"
                        d="M 3.99947 3.997493 L 85.63894 3.998471 "
                        stroke="#E5E5E5"
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="round" transform="matrix(0.613411, 0.437224, -0.435317, 0.610736, 28.138421, 3.587267)" fill="none" stroke-linejoin="round"
                        d="M 20.001147 -8.001704 L 3.99947 3.997493 L 20.001327 16.002237 "
                        stroke="#E5E5E5"
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="butt" transform="matrix(0.744008, 0.103603, -0.103439, 0.742833, 77.425603, 39.430799)" fill="none" stroke-linejoin="miter"
                        d="M -0.000128216 4.000306 L 88.866132 4.000613 "
                        stroke="#E5E5E5"
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="round" transform="matrix(0.655341, 0.370015, -0.368745, 0.65309, 141.770516, 47.790995)" fill="none" stroke-linejoin="miter"
                    ...
                    <path stroke-linecap="butt" transform="matrix(0.613411, 0.437224, -0.435317, 0.610736, 28.138421, 3.587267)" fill="none" stroke-linejoin="miter"
                        d={`M ${maxFillLine3 - fillLine3 + 2} 3.997493 L ${maxFillLine3} 3.998471 `}
                        stroke={line3 > 0 ? '#000000' : '#E5E5E5'}
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="round" transform="matrix(0.613411, 0.437224, -0.435317, 0.610736, 28.138421, 3.587267)" fill="none" stroke-linejoin="round"
                        d="M 20.001147 -8.001704 L 3.99947 3.997493 L 20.001327 16.002237 "
                        stroke={errow === 100 ? "#000000" : '#E5E5E5'}
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="butt" transform="matrix(0.744008, 0.103603, -0.103439, 0.742833, 77.425603, 39.430799)" fill="none" stroke-linejoin="miter"
                        d={`M ${maxFillLine2 - fillLine2} 4.000306 L ${maxFillLine2} 4.000613 `}
                        stroke={line2 > 0 ? '#000000' : '#E5E5E5'}
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                    <path stroke-linecap="round" transform="matrix(0.655341, 0.370015, -0.368745, 0.65309, 141.770516, 47.790995)" fill="none" stroke-linejoin="miter"
                        d={`M ${maxFillLine1 - fillLine1 + 2} 3.998596 L ${maxFillLine1} 3.999024 `}
                        stroke={line1 > 0 ? "#000000" : '#E5E5E5'}
                        stroke-width="8" stroke-opacity="1" stroke-miterlimit="4" />
                </svg>
            </div>
            <p
